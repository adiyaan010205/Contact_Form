...
├── style.css          # Styles: layout, colors, animations
├── script.js          # JS: validation logic and interactivity
...
* **Change Colors:**
  Modify CSS variables in `:root` inside `style.css`.

* **Adjust Validation:**
  Edit validation logic in `script.js` to suit your data requirements.

* **Tweak Animations:**
  Update keyframes or transition durations in `style.css`.
...
## 📸 Preview
![image](https://github.com/user-attachments/assets/8082a06a-698c-4f93-9feb-55ce4f83ad23)
